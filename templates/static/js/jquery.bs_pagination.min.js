...
(function (e) {
    ...
    var f = function (F, k, g, J, u) {
        ...
        if (B.showRowsInfo && B.showRowsDefaultInfo) {
            //var o = ((B.currentPage - 1) * B.rowsPerPage) + 1, n = Math.min(o + B.rowsPerPage - 1, B.totalRows), A = o + "-" + n + " " + rsc_bs_pag.total_rows_label + " " + B.totalRows + " " + rsc_bs_pag.rows_info_records + " (" + rsc_bs_pag.current_page_abbr_label + B.currentPage + rsc_bs_pag.total_pages_abbr_label + B.totalPages + ")", j = c(B.nav_rows_info_id_prefix, F);
            var A =  " 总页数："  + B.totalPages, j = c(B.nav_rows_info_id_prefix, F);
            e("#" + j).html(A)
        }
        if (u) {
